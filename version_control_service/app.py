...
"""
@文件: app.py
@說明: Version Control Service啟動文件
@時間: 2025-01-09
@作者: LiDong
"""
import json
...
from controllers.version_control_controller import init_version_control_controller
from loggers import logger
from views.version_control_api import blp as version_control_blp
...
def create_app(app):
    ...
    app.config["API_TITLE"] = "Version Control REST API"
    ...
    # 初始化版本控制控制器
    init_version_control_controller()
    ...
    # 注册蓝图
    api = Api(app)
    api.register_blueprint(version_control_blp)
    return app
...
if __name__ == "__main__":
    app = create_app(app)
    print("===================Version Control Service starting============================")
