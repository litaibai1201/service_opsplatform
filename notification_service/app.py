...
def create_app(app):
    ...
    app.config["API_TITLE"] = "Notification Service REST API"
    ...
    app.config["JWT_SECRET_KEY"] = "NotificationService2025!"
...
if __name__ == "__main__":
    ...
    print("健康檢查: http://localhost:8094/api/v1/health")
    print("管理界面: http://localhost:8094/swagger-ui")
    print("========================================================")
    # serve(app, host="0.0.0.0", port=8094, threads=30)
