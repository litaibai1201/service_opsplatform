...
"""
@文件: app.py
@說明: Database Design service啟動文件
@時間: 2025-01-09
@作者: LiDong
"""
import json
...
from configs.app_config import REDIS_DATABASE_URI, MONGODB_URI, SERVER_HOST, SERVER_PORT
...
def create_app(app):
    ...
    app.config["API_TITLE"] = "Database Design REST API"
    ...
    # 初始化数据库设计控制器
    init_db_design_controller(db_instance)
...
if __name__ == "__main__":
    app = create_app(app)
    print("===================Database Design Service starting============================")
