...
from controllers.search_controller import init_search_controller
...
def create_app(app):
    ...
    app.config["API_TITLE"] = "Search Service REST API"
    ...
    app.config["JWT_SECRET_KEY"] = "SearchService2025!"
...
if __name__ == "__main__":
    ...
    print("健康檢查: http://localhost:8091/health")
    print("管理界面: http://localhost:8091/swagger-ui")
    print("========================================================")
    # serve(app, host="0.0.0.0", port=8091, threads=30)
