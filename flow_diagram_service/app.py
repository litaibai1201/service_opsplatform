...
from configs.app_config import REDIS_DATABASE_URI, MONGODB_URI, SERVER_HOST, SERVER_PORT, SECRET_KEY, DIAGRAM_EXPORT_PATH
from dbs.mongodb import init_mongodb
from controllers.flow_diagram_controller import init_flow_diagram_controller
from loggers import logger
from views.flow_diagram_api import blp as flow_diagram_blp
...
def create_app(app):
    ...
    app.config["API_TITLE"] = "Flow Diagram REST API"
    ...
    # 创建导出目录
    os.makedirs(DIAGRAM_EXPORT_PATH, exist_ok=True)
    
    # 初始化流程图控制器
    init_flow_diagram_controller(db_instance)
    ...
    # 注册蓝图
    api = Api(app)
    api.register_blueprint(flow_diagram_blp)
...
if __name__ == "__main__":
    app = create_app(app)
    print("===================Flow Diagram Service starting============================")
