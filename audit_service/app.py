...
from views.audit_api import blp as audit_blp
from views.internal_api import internal_blp
...
def create_app(app):
    ...
    app.config["API_TITLE"] = "Audit Service REST API"
    ...
    app.config["JWT_SECRET_KEY"] = "AuditService2025!"
    ...
    # 注册蓝图
    api = Api(app)
    api.register_blueprint(audit_blp)
...
if __name__ == "__main__":
    ...
    print("健康檢查: http://localhost:8092/health")
    print("內部API健康檢查: http://localhost:8092/internal/health")
    print("管理界面: http://localhost:8092/swagger-ui")
    print("========================================================")
    # serve(app, host="0.0.0.0", port=8092, threads=30)
