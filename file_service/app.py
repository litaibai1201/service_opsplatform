...
from controllers.file_controller import init_file_controller
from loggers import logger
from views.file_api import blp as file_blp
...
def create_app(app):
    ...
    app.config["API_TITLE"] = "File Service REST API"
    ...
    app.config["JWT_SECRET_KEY"] = "FileService2025!"
...
if __name__ == "__main__":
    app = create_app(app)
    print("===================File Service starting============================")
    print(f"服務將在 http://{SERVER_HOST}:{SERVER_PORT} 啟動")
    print("健康檢查: http://localhost:8090/health")
    print("管理界面: http://localhost:8090/swagger-ui")
    print("========================================================")
    # serve(app, host="0.0.0.0", port=8090, threads=30)
