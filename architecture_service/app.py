...
from controllers.architecture_controller import init_architecture_controller
from loggers import logger
from views.architecture_api import blp as architecture_blp
...
def create_app(app):
    ...
    app.config["API_TITLE"] = "Architecture REST API"
    ...
    # 初始化架构控制器
    init_architecture_controller(db_instance)
    ...
    # 注册蓝图
    api = Api(app)
    api.register_blueprint(architecture_blp)
